...
class C3D_visual_only(nn.Module):
    def __init__(self, drop_p_v=0.2, visual_dim=1024, fc_hidden_1=128, num_classes=2):  #visual_dim=4096
...
class  C1D_tactile_test1(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv1d(in_channels=1, out_channels=10, kernel_size=1, stride=1)
...
class C3D_vision_C1D_tactile(nn.Module):
     def __init__(self, drop_p_v=0.2, visual_dim=1024, fc_hidden_1=128,fc_hidden_t = 20,num_classes=2):#, fc_hidden2=128, num_classes=50):
        super(C3D_vision_C1D_tactile, self).__init__()
        ...
        self.fc1 = nn.Linear(fc_hidden_1+fc_hidden_t, fc_hidden_1)
        self.fc2 = nn.Linear(fc_hidden_1, num_classes)
        self.drop_p=drop_p_v
     ...
     def forward(self,x_3d_v,x_1d_t):
         x_v=self.visual_c3d(x_3d_v)
         x_t=self.tactile_c1d(x_1d_t)
