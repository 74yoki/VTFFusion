...
true = open("E:/github/fu_Experimental_results/C3D_vision_C1D_flex-y_targets.txt","r")
y_trueStr = true.read()  
...
pred = open("E:/github/fu_Experimental_results/C3D_vision_C1D_flex-y_pred.txt","r")
y_predStr =pred.read()    
