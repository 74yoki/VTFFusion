...
class C3D_vision_C1D_flex(nn.Module):
     def __init__(self, drop_p_v=0.2, visual_dim=1024, fc_hidden_1=128,fc_hidden_f = 20,num_classes=2): #visual_dim=4096
        super(C3D_vision_C1D_flex, self).__init__()
        ...
        self.fc1 = nn.Linear(fc_hidden_1+fc_hidden_f, fc_hidden_1)
        self.fc2 = nn.Linear(fc_hidden_1, num_classes)
        self.drop_p=drop_p_v
        
        
     def forward(self,x_3d_v,x_1d_f):
         x_v=self.visual_c3d(x_3d_v)
         x_f=self.flex_c1d(x_1d_f)
