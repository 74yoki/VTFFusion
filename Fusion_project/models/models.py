...
class C3D(nn.Module):
     def __init__(self, drop_p_v=0.2, visual_dim=2048, fc_hidden_1=128,fc_hidden_t = 20,fc_hidden_f = 20,num_classes=2):
        ...
        self.fc1 = nn.Linear(fc_hidden_1+fc_hidden_t+fc_hidden_f, fc_hidden_1)
        self.fc2 = nn.Linear(fc_hidden_1, num_classes)
        self.drop_p=drop_p_v
        
        

     def forward(self,x_3d_v,x_1d_t,x_1d_f):
...
class C3D_visual_only(nn.Module):
    def __init__(self, drop_p_v=0.2, visual_dim=2048, fc_hidden_1=128, num_classes=2):  
