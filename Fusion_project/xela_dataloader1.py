...
def train_test_dataset(path,visual_seq_length,tactile_seq_length,flex_seq_length,log,flag):    
...
class MyDataset(Dataset):
    def __init__(self, image_paths, visual_seq_length, tactile_seq_length,flex_seq_length,transform_v,transform_t,transform_f,log,flag):
        ...
        self.log=log
        self.flag=flag
        self.dataset=train_test_dataset(self.image_paths,self.visual_seq_length,self.tactile_seq_length,self.flex_seq_length,self.log,self.flag)
        le = LabelEncoder()
        le.fit(self.classes)
